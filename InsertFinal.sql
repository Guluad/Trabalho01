...
('Gustavo Andrade','gugu662','M','guguadrade662@outlook.com','odjfbop',002,002),
...
INSERT INTO Exemplar (Titulo,Autor,genero,Cod_exemplar,Editora,Cod_livro,Cod_negocio) values
('Inferno','Dan Brown','Romance',666,'Arqueiro',626,200),
('As cronicas de narnia','C. S. Lewis','Aventura',886,'HarperCollins',222,100),
('O Diabo dos Números','Hans Magnus Enzensberger','Infanto-juvenil',333,'Seguinte',556,300);


INSERT INTO Livro (preço,Cod_livro,Cod_exemplar) values
(40.90,626,666),
(29.99,222,886),
(30.00,556,333);
